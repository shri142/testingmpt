# Generated by Django 4.0.5 on 2022-06-15 05:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Mentee', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.studentprofile')),
                ('Mentor', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.mentorprofile')),
            ],
        ),
    ]
